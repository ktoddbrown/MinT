---
title: Variable Composition of Microbial Biomass Affects the Accuracy of Microbial
  Explicit Models Simulation
...
kable(monod_r_results_good, digits = c(2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c('Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S2:** Goodness of fit of monod model calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
...
# mend_r_results_good<-rbind(mend_r1$goodness[2,c(4:7)],
#                      mend_r2$goodness[2,c(4:7)],
#                      mend_r3$goodness[2,c(4:7)],
#                      mend_r4$goodness[2,c(4:7)])
...
kable(t.s2.1, digits = c(2, 2, 2, 3), align = 'c', "html", booktabs=T, col.names = c('$\\V_{MAX}$', '$\\K_{M}$', 'CUE', '$\\m_{R}$'), row.names=T, caption = "_**Table S3:** MEND model parameters calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(mend_r_results_good, digits = c(2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c('Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S4:** Goodness of fit of MEND model calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 2) %>%
  group_rows("Substrate", 3, 4) %>%
...
kable(t.s3.1, digits = c(2, 2, 3, 2, 2), align = 'c', "html", booktabs=T, col.names = c('$\\V_{MAX}$', '$\\K_{M}$', '$\\m_{R}$', '$\\f_{0}$', '$\\Y_{S}$'), row.names=T, caption = "_**Table S5:** DEB model parameters calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(deb_r_results_good, digits = c(2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c('Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S6:** Goodness of fit of DEB model calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 2) %>%
  group_rows("Substrate", 3, 4) %>%
...
t.s4.1<-data.frame(Name=rep(c("All", "Broth", "Glass", "Wool",
                    ...
                    "Broth - Celluloze", "Broth - Glucose",
                    "Glass - Celluloze", "Glass - Glucose",
                    "Wool - Celluloze", "Wool - Glucose"), each =2),
...
kable(monod_all_results_good, digits = c(0, 2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c(" " , 'Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S8:** Goodness of fit of Monod model calibrated against respiration rate and protein/DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
...
kable(t.s5.1, digits = c(0, 0, 2, 2, 2, 3, 2), align = 'c', "html", booktabs=T, col.names = c(" "," ", '$\\V_{MAX}$', '$\\K_{M}$', 'CUE', '$\\m_{R}$', 'Conversion factor'), row.names=F, caption = "_**Table S9:** MEND model parameters calibrated against respiration rate and protein/DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 2) %>%
  group_rows("Structure", 3, 8) %>%
  group_rows("Substrate", 9, 12) %>%
...
kable(mend_all_results_good, digits = c(0, 2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c(" " , 'Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S10:** Goodness of fit of MEND model calibrated against respiration rate and protein/DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("Protein", 1, 8, label_row_css = "background-color: #666; color: #fff;") %>%
  group_rows("All", 1, 2) %>%
  group_rows("Structure", 3, 4) %>%
...
deb_all_results_par<-read.csv("deb_all_results_par")
deb_all_results_good<-read.csv("deb_all_results_good")
...
kable(t.s6.1, digits = c(0, 2, 2, 3, 2, 2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c(" ",'$\\V_{MAX}$', '$\\K_{M}$', '$\\m_{R}$', '$\\f_{0}$', '$\\Y_{S}$', '$\\R_{Proteins}$', '$\\R_{DNA}$', '$\\"S"_{DNA}$'), row.names=F, caption = "_**Table S11:** DEB model parameters calibrated against respiration rate, protein and DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(deb_all_results_good, digits = c(0, 2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c(" " , 'Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S12:** Goodness of fit of DEB model calibrated against respiration rate, protein and DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 3) %>%
