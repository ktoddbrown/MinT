monod_all<-function(data, FACT){
  ...
  estim<-function(odeset){
    ...
    par_mcmc<-modMCMC(f=cost, p=c(Vmax=0.1, Km=3, CUE=0.5, k=1e-3, fp=0.5, fd=0.01), 
                      lower=c(Vmax=1e-6, Km=1e-3, CUE=0, k=1e-6, fp=0, fd=0),
                      upper=c(Vmax=10, Km=100, CUE=1, k=10, fp=1, fd=1), niter=10000)
