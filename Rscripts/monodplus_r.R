monodplus_r<-function(data, FACT){
  ...
  parnames<-c("Vmax", "Km", "CUE", "mr", "k", "Cmic_0")
  ...
  estim<-function(odeset){
    ...
    par_mcmc<-modMCMC(f=cost, p=c(Vmax=0.1, Km=3, CUE=0.5, mr=0.01, k=1e-3, Cmic_0=0.01), 
                      lower=c(Vmax=1e-3, Km=1e-3, CUE=0, mr=1e-5, k=1e-6, Cmic_0=1e-5),
                      upper=c(Vmax=10, Km=100, CUE=1, mr=10, k=10, Cmic_0=5), niter=10000)
