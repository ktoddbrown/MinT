monodplus_DNA<-function(data, FACT){
  ...
  parnames<-c("Vmax", "Km", "CUE", "mr", "k", "fd")
  ...
  estim<-function(odeset){
    ...
    par_mcmc<-modMCMC(f=cost, p=c(Vmax=0.1, Km=3, CUE=0.5, mr=0.01, k=1e-3, fd=0.5), 
                      lower=c(Vmax=1e-3, Km=1e-3, CUE=0, mr=1e-5, k=1e-6, fd=0),
                      upper=c(Vmax=10, Km=100, CUE=1, mr=10, k=10, fd=1), niter=10000)
