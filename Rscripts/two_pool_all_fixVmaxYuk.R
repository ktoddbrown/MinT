two_pool_all_fixVmaxYuk<-function(data, FACT){
  ...
  deriv<-function(time, state, pars){
    ...
    with(as.list(c(state, pars)),{
      ...
      dR<-Cu-f*R
      dS<-f*R*0.3731948 - 0.007046304*S
      dC<--Cu + 0.007046304*S
  ...
  estim<-function(odeset){
    ...
    par_mcmc<-modMCMC(f=cost, p=c(Km=3, f=4, fpr=0.5, fps=0.5, fds=0.03),
                      lower=c(Km=1e-2, f=1e-3, fpr=0, fps=0, fds=0),
                      upper=c(Km=20, f=100, fpr=1, fps=1, fds=1), niter=10000)
