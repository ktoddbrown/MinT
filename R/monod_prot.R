monod_prot<-function(data, FACT){
  ...
  estim<-function(odeset){
    ...
    par_mcmc<-modMCMC(f=cost, p=c(Vmax=0.1, Km=3, CUE=0.5, k=1e-3, fd=0.5, Cmic_0=0.01),
                      lower=c(Vmax=1e-6, Km=1e-3, CUE=0, k=1e-6, fd=0, Cmic_0=1e-6),
                      upper=c(Vmax=10, Km=100, CUE=1, k=10, fd=1, Cmic_0=10), niter=10000)
