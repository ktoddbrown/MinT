...
##remove OTUs with all zeros
fungi2<-fungi[, colSums(fungi!=0)>0]
...
kable(t.s2.1, digits = c(2, 2, 2, 3), align = 'c', "html", booktabs=T, col.names = c('v', 'k', '$\\Y_{CUE}$', 'h', 'm'), row.names=T, caption = "_**Table S5:** Monod plus model parameters calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(t.s3.1, digits = c(2, 2, 3, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c('v', 'k', 'h', 'f', 'm', 'Y'), row.names=T, caption = "_**Table S7:** Sub-microbial model parameters calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(two_pool_r_results_good[, c(3:6)], digits = c(2, 2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c('Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S8:** Goodness of fit of Sub-microbial model calibrated against respiration rate across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 2) %>%
  group_rows("Substrate", 3, 4) %>%
...
kable(t.s4.3, digits = c(0, 2, 2, 2, 3, 3), align = 'c', "html", booktabs=T, col.names = c(" ", 'v', 'k', '$\\Y_{CUE}$', 'm', '$\\f_{DNA}$'), row.names=F, caption = "_**Table S13:** Monod model parameters calibrated against respiration rate and DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(t.s5.1, digits = c(0, 2, 2, 2, 3, 3, 3, 3), align = 'c', "html", booktabs=T, col.names = c(" ", 'v', 'k', '$\\Y_{CUE}$', 'h', 'm', '$\\f_{Proteins}$', '$\\f_{DNA}$'), row.names=F, caption = "_**Table S15:** Monod plus model parameters calibrated against respiration rate, protein and DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(t.s5.2, digits = c(0, 2, 2, 2, 3, 3, 3), align = 'c', "html", booktabs=T, col.names = c(" ", 'v', 'k', '$\\Y_{CUE}$', 'h', 'm', '$\\f_{Proteins}$'), row.names=F, caption = "_**Table S17:** Monod plus model parameters calibrated against respiration rate and protein concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(t.s5.3, digits = c(0, 2, 2, 2, 3, 3, 3), align = 'c', "html", booktabs=T, col.names = c(" ", 'v', 'k', '$\\Y_{CUE}$', 'h', 'm', '$\\f_{DNA}$'), row.names=F, caption = "_**Table S19:** Monod plus model parameters calibrated against respiration rate and DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
two_pool_all_fixYukfVmax2$goodness
...
#                          c(Vmax = 0.2761818, 
#                            two_pool_all_fixYukfVmax2[[1]]$pars[1],
#                            two_pool_all_fixYukfVmax2[[1]]$pars[2],
#                            f = 0.2373511,
#                            k = 0.004915818,
#                            Yu = 0.3565256,
#                            two_pool_all_fixYukfVmax2[[1]]$pars[c(3:5)],
#                            RS_0 = 0.06185237),
#                          c(Vmax = 0.2761818, 
#                            two_pool_all_fixYukfVmax2[[2]]$pars[1],
#                            two_pool_all_fixYukfVmax2[[2]]$pars[2],
#                            f = 0.2373511,
#                            k = 0.004915818,
#                            Yu = 0.3565256,
#                            two_pool_all_fixYukfVmax2[[2]]$pars[c(3:5)],
#                            RS_0 = 0.06185237),
#                          c(Vmax = 0.2761818, 
#                            two_pool_all_fixYukfVmax2[[3]]$pars[1],
#                            two_pool_all_fixYukfVmax2[[3]]$pars[2],
#                            f = 0.2373511,
#                            k = 0.004915818,
#                            Yu = 0.3565256,
#                            two_pool_all_fixYukfVmax2[[3]]$pars[c(3:5)],
#                            RS_0 = 0.06185237),
...
kable(t.s6.1, digits = c(0, 2, 2, 3, 3, 3, 2, 3, 3, 3, 2), align = 'c', "html", booktabs=T, col.names = c(" ","v", 'k', 'h', 'f', 'm', 'Y', '$\\B_{R-Proteins}$', '$\\B_{S-Proteins}$', '$\\B_{S-DNA}$', '$\\RS_{0}$'), row.names=F, caption = "_**Table S21:** Sub-microbial model parameters calibrated against respiration rate, protein and DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 1) %>%
  group_rows("Structure", 2, 4) %>%
  group_rows("Substrate", 5, 6) %>%
...
kable(two_pool_all_results_good[, c(1, 4:7)], digits = c(0, 2, 2, 2, 2), align = 'c', "html", booktabs=T, col.names = c(" " , 'Log Likelihood', '$\\R^{2}$', 'Number of parameters', 'AIC'), row.names=F, caption = "_**Table S21:** Goodness of fit of Sub-microbial model calibrated against respiration rate, protein and DNA concentration across all treatments (All), for different levels of incubation system complexity separately (Structure), for Glucose and Celluloze treatments separately (Substrate), and for all experimental treatments separatelly (Each). See Materials and Methods for symbols explanation._") %>% 
  kable_styling() %>% 
  group_rows("All", 1, 3) %>%
  group_rows("Structure", 4, 6) %>%
  group_rows("Substrate", 7, 9) %>%
...
$~$
$~$
```{r correlation figure, echo=FALSE, fig.height=12, fig.width=16, fig.cap="Fig. S3: Relative abundance of bacterial (a) and fungal (b) species in three experimental treatments differing in presence/absence of physical structure. Species with relative abundance above 0.5% are plotted. Their abundance is visualized by colour scale. Effect of bacterial and fungal composition of microbial community (expressed as multivariate mean distance between groups; see Material and Methods section) on overall microbial community affinity to substrate (i.e. parameter k - (a)) and abundance of proteins in microbial biomass (i.e. sum of protein abundance in biomass reserve and struscture - (b)). The values on y-axes are expressed as a mean difference between groups in order to allow unbiased correlation with microbial community structure metric (see Matrial and Methods section)."}
#Heatmap
bac.tax<-as.data.frame(read.csv(file=c("./Community_analysis/OTU_bacteria.txt"), header=T,
                             sep="\t"))
...
#Only genus with abundance above 0.05%
heat1<-ggplot(bac_gen_f[bac_gen_f$Abundance>0.0005, ], aes(Structure, Genus)) +
...
##Fungi
f.tax<-as.data.frame(read.csv(file=c("./Community_analysis/OTU_fungi.txt"), header=T,
                             sep="\t"))
...
#Genus with abundance above 0.05%
heat2<-ggplot(f_gen_f[f_gen_f$Abundance>0.0005, ], aes(Structure, Genus)) +
...
corplot1.p<-coefficients(nls(Km~exp(Dist*x)-a, dpars4, start = list(x=10, a=2)))

corplot1<-ggplot(dpars4[dpars4$group=="Bacteria", ], aes(Dist, Km))+
  geom_point(cex=6, aes(fill=Structure), show.legend=T, shape=21)+
  geom_point(data=dpars4[dpars4$group=="Fungi", ], cex=6, 
             aes(x=Dist, y=Km, fill=Structure), show.legend=F, shape=22)+
  scale_fill_manual(values = c("black", "grey", "white"))+
  stat_function(fun = function(x){(exp(x*corplot1.p[1])-corplot1.p[2])}, lwd=1, lty=2, colour="grey30")+
  xlab("16S and ITS Distance")+
  ggtitle("c)")+
  ylab("Affinity to substrate (relative difference)")+
  theme_min+theme(legend.title = element_blank(),
                  legend.position = c(0.2,0.7),
                  plot.margin = unit(c(0.5,1,0.5,2), "in"))

corplot2<-ggplot(dpars4[dpars4$group=="Bacteria", ], aes(Dist, fps+fpr))+
  geom_point(cex=6, aes(fill=Structure), show.legend=F, shape=21)+
  geom_point(data=dpars4[dpars4$group=="Fungi", ], cex=6, 
             aes(x=Dist, y=fps+fpr, fill=Structure), show.legend=F, shape=22)+
  stat_smooth(method = lm, colour="grey30", lty=2, se=F)+
  scale_fill_manual(values = c("black", "grey", "white"))+
  ggtitle("d)")+
  theme_min+xlab("16S and ITS Distance")+
  ylab("Proteins abundance (relative difference)")+
  theme(plot.margin = unit(c(0.5,1,0.5,2), "in"))


grid.arrange(heat1, heat2, corplot1, corplot2, nrow=2)

```

##Supplementary figure
```{r Monod and Monod plus model parameters, echo=FALSE, fig.height=24, fig.width=20, message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap="Fig. S1: Monod (a) and Monod plus (b) model parameters (v - maximum velocity constant, k - affinity constant, $Y_{CUE}$ - carbon use efficiency, m - microbial biomass decay rate constant, h - specific maintenance rate constant) estimated separately for three different types of physical barriers presented in incubation bottle (BROTH - black symbols, GLASS - grey symbols and WOOL - empty symbols). Symbols represent best parameters values estimated by the Differential Evolution Algorithm and error bars represent standard deviation of posterior parameters distribution estimated by Constrained Markov Chain Monte Carlo simulation. Parameters estimation was constrained by either observed respiration rates, observed respiration rates and cellular proteins concentration, observed respiration rates and DNA concentration or by all measurements at the same time."}
