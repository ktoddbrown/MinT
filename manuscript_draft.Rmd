...
In microbial enzyme models, microbial biomass produce extracellular enzymes. The way the carbon is partitioned between $C_{MB}$, $CO_{2}$ and $C_{Enz}$ can follow different mechanisms.  
